      ...
      <main className="min-h-screen bg-background-light dark:bg-background-dark relative overflow-hidden">
        ...
        <div className="flex min-h-screen pt-[72px]">
          ...
          <div className="flex-1 relative z-10 flex flex-col">
            <div className="flex-1 max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-10 py-8 sm:py-12">
              {activeTab === 'profile' && (
              ...
              {activeTab === 'orders' && (
                <div className="flex flex-col gap-10">
                  <div className="flex flex-col gap-3 pt-4">
                    <h1 className="font-serif italic text-4xl sm:text-5xl text-gray-900 dark:text-white tracking-wide">
                      Order History
                    </h1>
              ...
              {activeTab === 'settings' && (
                <div className="flex flex-col gap-10">
                  ...
                  <div className="glass-card rounded-2xl p-6 sm:p-8 max-w-2xl flex flex-col gap-8">
