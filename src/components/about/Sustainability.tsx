        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="group relative overflow-hidden rounded-lg bg-slate-50 dark:bg-surface-dark border border-slate-100 dark:border-border-dark shadow-md h-[400px] transition-colors duration-500">
            <div className="absolute inset-0">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-white dark:from-surface-dark via-white/40 dark:via-surface-dark/40 to-transparent opacity-90 transition-colors duration-500"></div>
            </div>
          ...
          <div className="group relative overflow-hidden rounded-lg bg-slate-50 dark:bg-surface-dark border border-slate-100 dark:border-border-dark shadow-md h-[400px] transition-colors duration-500">
            <div className="absolute inset-0 flex items-center justify-center bg-slate-50 dark:bg-surface-dark transition-colors duration-500">
              <svg className="w-48 h-48 text-slate-300 dark:text-slate-600 opacity-50 group-hover:opacity-40 transition-opacity duration-500 text-slate-300" fill="none" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
